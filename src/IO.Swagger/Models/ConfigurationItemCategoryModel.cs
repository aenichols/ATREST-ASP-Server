...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemCategoryModel : IEquatable<ConfigurationItemCategoryModel>
    { 
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ConfigurationItemCategoryModel)obj);
        }

        /// <summary>
        /// Returns true if ConfigurationItemCategoryModel instances are equal
        /// </summary>
        /// <param name="other">Instance of ConfigurationItemCategoryModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemCategoryModel other)
        {
            ...
            return 
                ...
                (
                    IsClientPortalDefault == other.IsClientPortalDefault ||
                    IsClientPortalDefault != null &&
                    IsClientPortalDefault.Equals(other.IsClientPortalDefault)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (IsClientPortalDefault != null)
                    hashCode = hashCode * 59 + IsClientPortalDefault.GetHashCode();
        ...
        public static bool operator ==(ConfigurationItemCategoryModel left, ConfigurationItemCategoryModel right)
        {
