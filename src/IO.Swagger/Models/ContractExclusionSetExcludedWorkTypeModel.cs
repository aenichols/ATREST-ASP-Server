...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ContractExclusionSetExcludedWorkTypeModel : IEquatable<ContractExclusionSetExcludedWorkTypeModel>
    { 
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ContractExclusionSetExcludedWorkTypeModel)obj);
        }

        /// <summary>
        /// Returns true if ContractExclusionSetExcludedWorkTypeModel instances are equal
        /// </summary>
        /// <param name="other">Instance of ContractExclusionSetExcludedWorkTypeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractExclusionSetExcludedWorkTypeModel other)
        {
            ...
            return 
                ...
                (
                    ExcludedWorkTypeID == other.ExcludedWorkTypeID ||
                    ExcludedWorkTypeID != null &&
                    ExcludedWorkTypeID.Equals(other.ExcludedWorkTypeID)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (ExcludedWorkTypeID != null)
                    hashCode = hashCode * 59 + ExcludedWorkTypeID.GetHashCode();
        ...
        public static bool operator ==(ContractExclusionSetExcludedWorkTypeModel left, ContractExclusionSetExcludedWorkTypeModel right)
        {
