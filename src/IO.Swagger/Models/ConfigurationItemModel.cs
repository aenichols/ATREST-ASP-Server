...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemModel : IEquatable<ConfigurationItemModel>
    { 
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ConfigurationItemModel)obj);
        }

        /// <summary>
        /// Returns true if ConfigurationItemModel instances are equal
        /// </summary>
        /// <param name="other">Instance of ConfigurationItemModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemModel other)
        {
            ...
            return 
                ...
                (
                    RmmDeviceAuditOperatingSystem == other.RmmDeviceAuditOperatingSystem ||
                    RmmDeviceAuditOperatingSystem != null &&
                    RmmDeviceAuditOperatingSystem.Equals(other.RmmDeviceAuditOperatingSystem)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (RmmDeviceAuditOperatingSystem != null)
                    hashCode = hashCode * 59 + RmmDeviceAuditOperatingSystem.GetHashCode();
        ...
        public static bool operator ==(ConfigurationItemModel left, ConfigurationItemModel right)
        {
