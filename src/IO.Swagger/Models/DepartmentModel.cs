...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DepartmentModel : IEquatable<DepartmentModel>
    { 
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DepartmentModel)obj);
        }

        /// <summary>
        /// Returns true if DepartmentModel instances are equal
        /// </summary>
        /// <param name="other">Instance of DepartmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepartmentModel other)
        {
            ...
            return 
                ...
                (
                    ...
                    PrimaryLocationID.Equals(other.PrimaryLocationID)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + PrimaryLocationID.GetHashCode();
