...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ContractExclusionSetExcludedRoleModel : IEquatable<ContractExclusionSetExcludedRoleModel>
    { 
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ContractExclusionSetExcludedRoleModel)obj);
        }

        /// <summary>
        /// Returns true if ContractExclusionSetExcludedRoleModel instances are equal
        /// </summary>
        /// <param name="other">Instance of ContractExclusionSetExcludedRoleModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractExclusionSetExcludedRoleModel other)
        {
            ...
            return 
                ...
                (
                    ExcludedRoleID == other.ExcludedRoleID ||
                    ExcludedRoleID != null &&
                    ExcludedRoleID.Equals(other.ExcludedRoleID)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ExcludedRoleID.GetHashCode();
        ...
        public static bool operator ==(ContractExclusionSetExcludedRoleModel left, ContractExclusionSetExcludedRoleModel right)
        {
