...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ParameterExpression : IEquatable<ParameterExpression>
    { 
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ParameterExpression {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ParameterExpression)obj);
        }

        /// <summary>
        /// Returns true if ParameterExpression instances are equal
        /// </summary>
        /// <param name="other">Instance of ParameterExpression to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (IsByRef != null)
                    hashCode = hashCode * 59 + IsByRef.GetHashCode();
                    if (CanReduce != null)
