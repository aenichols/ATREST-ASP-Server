...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceRoleDepartmentModel : IEquatable<ResourceRoleDepartmentModel>
    { 
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ResourceRoleDepartmentModel)obj);
        }

        /// <summary>
        /// Returns true if ResourceRoleDepartmentModel instances are equal
        /// </summary>
        /// <param name="other">Instance of ResourceRoleDepartmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceRoleDepartmentModel other)
        {
            ...
            return 
                ...
                (
                    IsDepartmentLead == other.IsDepartmentLead ||
                    IsDepartmentLead != null &&
                    IsDepartmentLead.Equals(other.IsDepartmentLead)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (IsDepartmentLead != null)
                    hashCode = hashCode * 59 + IsDepartmentLead.GetHashCode();
                    if (ResourceID != null)
        ...
        public static bool operator ==(ResourceRoleDepartmentModel left, ResourceRoleDepartmentModel right)
        {
